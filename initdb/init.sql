...
INSERT INTO `demanda` ( `centro`, `usuario`, `titulo`, `descricao`, `requisitos`, `tipo_sangue`, `urgencia`, `horario`) VALUES ( 2, 1, NULL, 'Nosso banco de sangue para o tipo **O Negativo**, o doador universal, atingiu um nível crítico devido a um aumento inesperado no número de cirurgias de emergência nesta semana. Este tipo sanguíneo é vital em situações críticas, pois pode ser transfundido para qualquer paciente, independentemente do seu tipo sanguíneo.Sua doação pode ser a diferença entre a vida e a morte para alguém que chegou em nosso hospital precisando de uma intervenção imediata.', 'Ter entre 16 e 69 anos, pesar mais de 50kg e estar em boas condições de saúde.', 'O+', 'Urgente', 'Seg a Sex, das 8h às 16h');
INSERT INTO `demanda` ( `centro`, `usuario`, `titulo`, `descricao`, `requisitos`, `tipo_sangue`, `urgencia`, `horario`) VALUES ( 2, 1, NULL, 'Nosso banco de sangue para o tipo **O Negativo**, o doador universal, atingiu um nível crítico devido a um aumento inesperado no número de cirurgias de emergência nesta semana. Este tipo sanguíneo é vital em situações críticas, pois pode ser transfundido para qualquer paciente, independentemente do seu tipo sanguíneo.Sua doação pode ser a diferença entre a vida e a morte para alguém que chegou em nosso hospital precisando de uma intervenção imediata.', 'Ter entre 16 e 69 anos, pesar mais de 50kg e estar em boas condições de saúde.', 'O+', 'Nivel Estavel', 'Seg a Sex, das 8h às 16h');
INSERT INTO `demanda` ( `centro`, `usuario`, `titulo`, `descricao`, `requisitos`, `tipo_sangue`, `urgencia`, `horario`) VALUES ( 2, 1, NULL, 'Nosso banco de sangue para o tipo **O Negativo**, o doador universal, atingiu um nível crítico devido a um aumento inesperado no número de cirurgias de emergência nesta semana. Este tipo sanguíneo é vital em situações críticas, pois pode ser transfundido para qualquer paciente, independentemente do seu tipo sanguíneo.Sua doação pode ser a diferença entre a vida e a morte para alguém que chegou em nosso hospital precisando de uma intervenção imediata.', 'Ter entre 16 e 69 anos, pesar mais de 50kg e estar em boas condições de saúde.', 'O+', 'Urgente', 'Seg a Sex, das 8h às 16h');
INSERT INTO `demanda` ( `centro`, `usuario`, `titulo`, `descricao`, `requisitos`, `tipo_sangue`, `urgencia`, `horario`) VALUES ( 2, 1, NULL, 'Nosso banco de sangue para o tipo **O Negativo**, o doador universal, atingiu um nível crítico devido a um aumento inesperado no número de cirurgias de emergência nesta semana. Este tipo sanguíneo é vital em situações críticas, pois pode ser transfundido para qualquer paciente, independentemente do seu tipo sanguíneo.Sua doação pode ser a diferença entre a vida e a morte para alguém que chegou em nosso hospital precisando de uma intervenção imediata.', 'Ter entre 16 e 69 anos, pesar mais de 50kg e estar em boas condições de saúde.', 'O+', 'Estoque Baixo', 'Seg a Sex, das 8h às 16h');
